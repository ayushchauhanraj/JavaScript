...
function loadIntoServer() {
  // var lastAdded =
  //   questionOperations.operations[questionOperations.operations.length - 1];
  // var id = lastAdded.id;
  ...
  //   .set(lastAdded);
  // promise
  //   .then(data => alert("Data has succesfully load into server"))
  //   .catch(err => {
  //     alert("Some Error in Loading data");
  //     console.log(err);
  //   });
