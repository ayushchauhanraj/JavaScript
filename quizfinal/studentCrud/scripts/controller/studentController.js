...
function showSlide(n) {
  document
    ...
    [allQuestion.currentSlide].classList.remove("active-slide");
  ...
  allQuestion.currentSlide = n;
  if (allQuestion.currentSlide === 0) {
    document.getElementById("previous").style.display = "none";
  } else {
...
function showNextSlide() {
  showSlide(allQuestion.currentSlide + 1);
  console.log(allQuestion.currentSlide);
}
